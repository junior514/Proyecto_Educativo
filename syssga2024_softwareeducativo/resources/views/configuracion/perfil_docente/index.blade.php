...
@section('contenido')
                ...
                <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                    <div class="table-responsive">
                        <table class="table ">
                            ...
                            <tr>
                                <td class="text-secondary"><b>N° Documento:</b></td>
                                <td>{{ $users->nroDoc }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td colspan="2" style="text-align: center;">
                                    <a class="btn btn-primary" href="" data-target="#modal-add-{{ $users->idDocente }}"
                                        data-toggle="modal">
    ...
    @include('configuracion.perfil_docente.modal')
        ...
        @if (count($errors) > 0)
            <script type="text/javascript">
                $(document).ready(function() {
                    ...
                    $('#modal-add-<?php echo old('idDocente'); ?>').modal('show');
